...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      get_admin_restaurant_id: { Args: { _user_id: string }; Returns: string }
    ...
    Enums: {
      ...
      table_order_status: "open" | "requesting_bill" | "paid" | "cancelled"
      table_status: "available" | "occupied" | "reserved" | "requesting_bill"
    }
    CompositeTypes: {
      [_ in never]: never
    }
