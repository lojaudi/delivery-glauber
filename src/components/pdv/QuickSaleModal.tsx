...
import { Search, Plus, Minus, ShoppingBag, Trash2, ChevronRight, ShoppingCart, ArrowLeft } from 'lucide-react';
      ...
      <DialogContent className="sm:max-w-4xl max-h-[90vh] flex flex-col p-4 sm:p-6">
        ...
        <div className="flex flex-1 gap-4 min-h-0">
          ...
          {(!isMobile || mobileView === 'cart') && (
            <div className={cn("flex flex-col", isMobile ? "flex-1" : "w-72 border-l pl-4")}>
              <div className="mb-3">
                <Input
